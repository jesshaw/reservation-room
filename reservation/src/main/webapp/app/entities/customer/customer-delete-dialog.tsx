  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="reservationApp.customer.delete.question">
          <Translate contentKey="reservationApp.customer.delete.question" interpolate={{ id: customerEntity.id }}>
        ...
        <ModalFooter>
          ...
          <Button id="lxm-confirm-delete-customer" color="danger" onClick={this.confirmDelete}>
