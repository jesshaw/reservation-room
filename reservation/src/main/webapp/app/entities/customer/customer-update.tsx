    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="reservationApp.customer.home.createOrEditLabel">
              <Translate contentKey="reservationApp.customer.home.createOrEditLabel">Create or edit a Customer</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : customerEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="firstNameLabel" for="customer-firstName">
                    <Translate contentKey="reservationApp.customer.firstName">First Name</Translate>
                  </Label>
                  <AvField
                ...
                <AvGroup>
                  <Label id="lastNameLabel" for="customer-lastName">
                    <Translate contentKey="reservationApp.customer.lastName">Last Name</Translate>
                  </Label>
                  <AvField
                ...
                <AvGroup>
                  <Label id="genderLabel" for="customer-gender">
                    <Translate contentKey="reservationApp.customer.gender">Gender</Translate>
                  </Label>
                  <AvInput
                    id="customer-gender"
                    type="select"
                  ...
                  >
                    <option value="MALE">{translate('reservationApp.Gender.MALE')}</option>
                    <option value="FEMALE">{translate('reservationApp.Gender.FEMALE')}</option>
                    <option value="OTHER">{translate('reservationApp.Gender.OTHER')}</option>
                  </AvInput>
                </AvGroup>
                <AvGroup>
                  <Label id="emailLabel" for="customer-email">
                    <Translate contentKey="reservationApp.customer.email">Email</Translate>
                  </Label>
                  <AvField
                    id="customer-email"
                    type="text"
                ...
                <AvGroup>
                  <Label id="phoneLabel" for="customer-phone">
                    <Translate contentKey="reservationApp.customer.phone">Phone</Translate>
                  </Label>
                  <AvField
                    id="customer-phone"
                    type="text"
                ...
                <AvGroup>
                  <Label id="addressLine1Label" for="customer-addressLine1">
                    <Translate contentKey="reservationApp.customer.addressLine1">Address Line 1</Translate>
                  </Label>
                  <AvField
                ...
                <AvGroup>
                  <Label id="addressLine2Label" for="customer-addressLine2">
                    <Translate contentKey="reservationApp.customer.addressLine2">Address Line 2</Translate>
                  </Label>
                  <AvField id="customer-addressLine2" type="text" name="addressLine2" />
                </AvGroup>
                <AvGroup>
                  <Label id="cityLabel" for="customer-city">
                    <Translate contentKey="reservationApp.customer.city">City</Translate>
                  </Label>
                  <AvField
                    id="customer-city"
                    type="text"
                ...
                <AvGroup>
                  <Label id="countryLabel" for="customer-country">
                    <Translate contentKey="reservationApp.customer.country">Country</Translate>
                  </Label>
                  <AvField
                    id="customer-country"
                    type="text"
                ...
                <AvGroup>
                  <Label for="customer-user">
                    <Translate contentKey="reservationApp.customer.user">User</Translate>
                  </Label>
                  <AvInput
                    id="customer-user"
                    type="select"
