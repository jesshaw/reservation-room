package com.lexiangmiao.hotel.reservation.config.timezone;

import com.lexiangmiao.hotel.reservation.ReservationApp;
import com.lexiangmiao.hotel.reservation.repository.timezone.DateTimeWrapper;
import com.lexiangmiao.hotel.reservation.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM lxm_date_time_wrapper where id=%d", fieldName, id);
    }
