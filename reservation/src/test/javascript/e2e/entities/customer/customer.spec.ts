...
describe('Customer e2e test', () => {
  ...
  it('should load create Customer page', async () => {
    ...
    expect(await customerUpdatePage.getPageTitle().getAttribute('id')).to.match(/reservationApp.customer.home.createOrEditLabel/);
  ...
  /*  it('should create and save Customers', async () => {
        async function createCustomer() {
            ...
            await customerUpdatePage.setEmailInput('#hs&#34;}c.=pse%8\p706uYu&gt;nV}}zA&gt;Z2$Svm_9U3-v1ck5Ub1K^ioq!rXQdc[;;*{MEsazID3i&lt;)zJoBcvMvCFXU@G6_/tsTut&#39;&#39;Z^x.j~AHG:Q4PKtRYtb\ar\#.-\SaI-YGj6sfzClsW`G&gt;T2KC9+SpHNNI!^qp4&lt;1G9UHQm)K0N|a&lt;\y$yp&lt;ta0&#39;:.XHsjjky7q[T_^~nlOj[bLX}i^D');
            expect(await customerUpdatePage.getEmailInput()).to.match(/#hs&#34;}c.=pse%8\p706uYu&gt;nV}}zA&gt;Z2$Svm_9U3-v1ck5Ub1K^ioq!rXQdc[;;*{MEsazID3i&lt;)zJoBcvMvCFXU@G6_/tsTut&#39;&#39;Z^x.j~AHG:Q4PKtRYtb\ar\#.-\SaI-YGj6sfzClsW`G&gt;T2KC9+SpHNNI!^qp4&lt;1G9UHQm)K0N|a&lt;\y$yp&lt;ta0&#39;:.XHsjjky7q[T_^~nlOj[bLX}i^D/);
  ...
  /*  it('should delete last Customer', async () => {
        ...
        expect(await customerDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/reservationApp.customer.delete.question/);
